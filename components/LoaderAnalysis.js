...
import
{ AiOutlineExclamationCircle } from 'react-icons/ai';
    ...
    return (<>
        <div className="analysis-container">
            ...
            <div className="analytics">
                ...
                {
                ongoingTransactions && Object.keys( ongoingTransactions ) ?. length === 0 ? (<p style={
                    {
                        fontSize: '20px',
                        textAlign: 'center',
                        color: 'gray'
                    ...
                    ongoingTransactions && Object.keys( ongoingTransactions ) ?. map( ( e, index ) => (<Grid item
                        xs={12}
                        sm={6}
                        md={4}
                        lg={3}
            ...
            >
              {ongoingTransactions &&
                ...
                <div className='filter-bottom'>
                    ...
                    <FilterButton image1="freight-wagon(1).png" image2="freight-wagon(2).png"
                        index={1}
                    ...
                    <FilterButton image1="van.png" image2="van(1).png"
                        index={0}
                ...
                {
                vehicleBelts && vehicleBelts ?. length === 0 ? (<p style={
                    {
                        fontSize: '20px',
                        textAlign: 'center',
                        color: 'gray'
                    ...
                    vehicleBelts && vehicleBelts ?. map( ( e, index ) => (<Grid item
                        xs={12}
                        sm={6}
                        md={4}
                        lg={3}
        ...
        {
        detailModalOpen ? (<AddMoreBagsModal showDivision
        ...
        {
        rejectModalOpen ? (<InfoModal open={rejectModalOpen}
            close={
            ...
            hideConfirm
            hideComment>
            <DefectiveBags transaction_id={
                rejectModalOpen ?. id
            }/>
        </InfoModal>) : null
    }
        {
        bagModifyModalOpen ? (<AddMoreBagsModal onlyBags
